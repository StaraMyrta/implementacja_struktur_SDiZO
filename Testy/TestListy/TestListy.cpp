...
void TestListy::sredniTestDodawania()
{
    ...
    double wyniki[3][7];                        //Testy dodawania elementów z przodu listy.
...
{
    double wyniki[3][7];                        //Testy usuwania elementów z przodu listy.
...
{
    double srednia = 0;
    for (int i = 0; i < 20; i++)               //Wynik to œrednia ze 100 dodañ na pocz¹tek listy o zmienianych za ka¿dym razem danych.
    {
        wypelnijListe(rozm);
        int elem = rand() % rozm;
        pomiar.czasStart();
