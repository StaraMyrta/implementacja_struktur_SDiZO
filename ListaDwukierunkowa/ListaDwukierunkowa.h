...
{
private:
    const string EXCEPTION_RANGE_DESC = "Nieprawidlowy indeks!";    //Sta³e przechowuj¹ce opisy wyj¹tku.
...
public:
    ...
    bool znajdz(int elem);                      //Sprawdza czy element o podanej wartoœci wystêpuje w liœcie.
